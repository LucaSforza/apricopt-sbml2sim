...
Tuttavia si possono studiare solo piccole parti di questi network metabolici, ovvero i pathway che studiano una specifica funzione cellulare. 
...
L'accuratezza di queste simulazioni dipende in modo cruciale dalle costanti cinetiche che governano le reazioni. Tali parametri risultano spesso difficili o impossibili da misurare sperimentalmente, lasciando un ampio margine di incertezza nei parametri dei modelli.

Però esiste il concetto di \textbf{paziente virtuale} inteso come una insieme di
...
I modelli biologici che vogliamo rappresentare sono normalizzati, ovvero la concentrazione delle specie (ovvero un insieme indistinguibile di entità chimiche) sono tutte comprese nell'intervallo $[0,1]$. Se la concentrazione di una specie è vicina al valore 1 significa che è molto espressa;
se invece è vicino a 0 allora è poco espessa.

Dato un ordinamento del valore delle concentrazioni normalizzato delle specie si vogliono trovare i parametri tali per cui l'ordinamento delle specie normalizzato esiste. Ovvero verificare 
se esiste un paziente virtuale che renda plausibile l'ordinamento e confrontare diversi pazienti virtuali per individuare il più plausibile.
