...
$n^i_j$ è la stochiometria della specie $i$ nella reazione $j$.
...
la concentrazione dell'output stesso, quindi seguendo la mass action rule \cite{klipp2009systems} l'equazione differenziale per gli output è come segue:
\[
