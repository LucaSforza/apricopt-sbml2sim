...
\newcommand{\bentedge}[2]{%
  \draw[-{Stealth}, bend right=30] (#1) to (#2);
}
...
\hypersetup{pdftitle={Un tool per la ricerca di virtual patients in biochemical networks}, pdfauthor={Luca Sforza}}
\title{Un tool per la ricerca di virtual patients in biochemical networks}
\author{Luca Sforza}
\IDnumber{2050030}
...
\includeonly{Cap_1,Cap_2,Cap_3,Cap_4,Cap_5, tool, openai, abstract}
...
% Abstract aggiunto nella frontmatter e inserito nella TOC
\cleardoublepage
\phantomsection
