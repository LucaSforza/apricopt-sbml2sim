...
\hypersetup{pdftitle={Un tool per la ricerca di virtual patients in biomchemical network}, pdfauthor={Luca Sforza}}
\title{Un tool per la ricerca di virtual patients in biomchemical network}
\author{Luca Sforza}
\IDnumber{2050030}
